...
```json
{
  ...
  "data": {
    ...
    "expires_at": "2025-01-15T10:07:00.000Z",
    "constraints": null
  }
}
```
...
**Auth required.** Keeps a long-running match alive. Must be sent within the challenge's configured heartbeat interval (default: every 5 minutes, with a grace period).
